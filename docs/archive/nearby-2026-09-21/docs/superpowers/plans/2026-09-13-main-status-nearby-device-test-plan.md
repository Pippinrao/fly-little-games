...
文档时序注意：[9 月 11 日交接](../../handoffs/2026-09-11-nearby-multiplayer-handoff.md)中的“没有产品入口”和[旧 M2–M5 状态](../../../../../superpowers/specs/m2-m5-status.md)中的“session 全部为桩”已不完全准确。[产品主线计划](2026-09-11-nearby-product-spine-plan.md)末尾包含 9 月 13 日更新，应结合当前源码阅读，不能只引用其早期基线。
