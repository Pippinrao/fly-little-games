...
| Toolchain manifest | SHA-256 `1bad5858d91611ff52cfa9bff251d71425431b459ff97ecf076e0f5c7781639d` |
...
| Installed `zlibstatic.lib` | SHA-256 `9f2898c18ee6e982ec5266ddcbd4cd8d068e9d0b6c3122f6ecb49d8be3e8d9ff` (identical across the feature and main worktrees) |
| Installed license | SHA-256 `845efc77857d485d91fb3e0b884aaa929368c717ae8186b66fe1ed2495753243` |
| Exact four-file install tree | canonical SHA-256 `f37a4b7b395b92578d7ddfa40ab026ad98ab9ca953a96591e621968cf9dcf545` |
...
The probe and zlib build directories are deleted and configured anew on every run after any stale generator/architecture check. The ignored manifest records both fresh `CMakeCCompiler.cmake` hashes/timestamps. In the final run, the probe identity was written at `2026-08-30T13:12:58.8548603Z`, the dependency identity at `2026-08-30T13:13:03.0623662Z`, the toolchain manifest at `2026-08-30T13:13:07.0788856Z`, and the preflight manifest at `2026-08-30T13:13:07.0948442Z`; both identity files have SHA-256 `98bdded1e548dbda5f379b3409a68fc0a6487ce0cbff98d01e95b2d850205cb2` and resolve to the same compiler executable/hash, VS instance, toolset, and SDK.
...
- Real zlib bootstrap: recreated-cache runs completed successfully after adding the deterministic path map; `zlibstatic.lib` remained SHA-256 `9f2898c18ee6e982ec5266ddcbd4cd8d068e9d0b6c3122f6ecb49d8be3e8d9ff` across the feature and main worktrees, the exact install contained no DLL or import library, and no transaction temporary survived.
...
- Complete pinned-Pester quality gate: `99 passed, 0 failed` in `85.56 s`; the focused bootstrap-only run was `53 passed, 0 failed` in `75.17 s`.
