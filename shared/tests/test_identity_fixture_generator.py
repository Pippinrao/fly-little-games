#!/usr/bin/env python3
"""Black-box tests for deterministic content-identity fixture generation."""
...
class IdentityFixtureGeneratorTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_generation_refuses_symlink_entries_when_supported(self) -> None:
        corpus = self.generate()
