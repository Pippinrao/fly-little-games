...
public final class GameTitleIndexTest {
    ...
    @Test public void changingLanguageKeepsTheRunningGameTitle() throws Exception {
        ...
        var request = new LaunchRequest("title-test", "title-test-variant", "builtin",
                // Staged bytes are what the surface loads, so the locator only has
                // to look like a bundled path; no bundled game is named here.
                "file:///android_asset/roms/library-entry.nes", null, PackageFormat.RAW,
