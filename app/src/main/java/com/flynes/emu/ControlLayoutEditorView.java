...
final class ControlLayoutEditorView extends View {
    ...
    ControlLayoutEditorView(Context context){super(context);setFocusable(true);setClickable(true);setContentDescription(context.getString(R.string.control_layout_hint));accessibility=new EditorAccessibilityHelper(this);ViewCompat.setAccessibilityDelegate(this,accessibility);}
