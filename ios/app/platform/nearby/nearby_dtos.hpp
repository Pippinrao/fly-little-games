...
namespace flynes::ios::nearby {

// iOS-local BLE/QR/Wi-Fi DTOs under ios/app/platform/. Not shared C ABI.
...
// Host-only fake: Keychain/Secure Enclave is the production friend backend.
// CoreBluetooth, Network.framework, and VideoToolbox are not opened here.
